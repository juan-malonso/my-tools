...
import { DeleteIcon, ModuleIcon, SettingIcon } from '@/components/common/icons';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-slate-800 w-[80%] h-[80%] max-w-6xl rounded-2xl shadow-2xl flex overflow-hidden border border-slate-600">
        {/* Sidebar */}
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-900/50 border border-slate-600 rounded-lg px-4 py-2.5 text-white focus:border-sky-500 focus:ring-1 focus:ring-sky-500 outline-none transition-all"
                    />
                  </div>
                  <div className="space-y-2">
  ...
  return (
    <div className="group flex items-center gap-3 bg-slate-900/30 hover:bg-slate-900/50 p-2 rounded-lg border border-slate-700/50 hover:border-slate-600 transition-all duration-200">
      <div
        ...
        className="w-8 h-8 rounded cursor-pointer shadow-sm hover:scale-105 transition-transform ring-1 ring-slate-700/50"
